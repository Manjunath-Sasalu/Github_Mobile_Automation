...
public class ExtentReportManager implements ITestListener
{
	...
	{		
		...
		htmlReporter.config().setDocumentTitle("Github Mobile Automation Result"); // Tile of report
		htmlReporter.config().setReportName("Github Search Repository"); // name of the report
